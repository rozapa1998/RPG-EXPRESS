//Condicional para el inicio de sesion
const ChequeoUsuario = () => {
    ...
    if(localStorage.getItem(usuario) === null || localStorage.getItem(password) === null){
        ...
        <div>
          Debes estar registrado para ingresar!
        </div>
      </div>`)
      setTimeout(() => {
          alerta.innerHTML=(``)
            ...
            let contraseña = getElementById("constraseña")
        while(usuario != localStorage.getItem("usuario") && contraseña != localStorage.getItem("contraseña")){
